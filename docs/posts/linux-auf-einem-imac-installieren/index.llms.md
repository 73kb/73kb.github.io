[![Bild: Der Dachs sitzt am Schreibtisch und installiert Linux / Nano Banana](dachs_am_schreibtisch.webp "Zeichnung: Ein Dachs in einem altmodischen Tweed-Anzug sitzt an einem hölzernen Schreibtisch auf dem ein iMac von 2019 steht und installiert darauf Linux.")](dachs_am_schreibtisch.webp "Bild: Der Dachs sitzt am Schreibtisch und installiert Linux / Nano Banana")
...
[![Screenshot: Befehl neofetch im Terminal](imac_neofetch.webp "Screenshot: Befehl neofetch im Terminal")](imac_neofetch.webp "Screenshot: Befehl neofetch im Terminal")
